...
import customers from "@/data/customers_pa.json";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Input } from "@/components/ui/input";
import { Badge } from "@/components/ui/badge";
import { Button } from "@/components/ui/button";
import { Separator } from "@/components/ui/separator";
import { Building2, Copy, MapPin, Phone, Mail, ArrowLeft } from "lucide-react";
            ...
            <div className="space-y-1">
              ...
              {row?.phone ? (
                <div className="flex items-center gap-2 text-sm text-muted-foreground break-words">
                  ...
                  <a className="hover:underline" href={`tel:${String(row.phone).replace(/\s/g, "")}`}>
                    {row.phone}
                  </a>
                </div>
              ) : null}
    ...
    <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 py-8">
      ...
      <div className="mt-6">
        <Input
          ...
          placeholder="Search by customer, address, contact, email, phone…"
